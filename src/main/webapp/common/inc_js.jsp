...
<script type="text/javascript" src="${ctx}/res/jquery/customize/fn/jquery.customize.fn.resize.js"></script>
<script type="text/javascript" src="${ctx}/res/jquery/customize/plugin/jquery.customize.plugin.DropDownSelect.js"></script>
<script type="text/javascript" src="${ctx}/res/jquery/customize/plugin/jquery.customize.plugin.ListSelectModal.js"></script>
<script type="text/javascript" src="${ctx}/res/jquery/customize/plugin/jquery.customize.plugin.ListSelectField.js"></script>
...
<script type="text/javascript" src="${ctx}/res/bs/js/bootstrap-editable.min.js"></script>
<script type="text/javascript" src="${ctx}/res/bs/js/bootstrap-table-editable.min.js"></script>
<script type="text/javascript" src="${ctx}/res/bs/js/bootstrap-table-contextmenu.min.js"></script>
<script type="text/javascript" src="${ctx}/res/bs/js/bootstrap-table-multiple-sort.js"></script>
